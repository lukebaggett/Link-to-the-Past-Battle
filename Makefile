...
OFILES = main.o ./lib/myLib.o ./lib/text.o ./lib/sprites.o
OFILES += ./images/title.o ./images/bg.o ./images/gameover.o

# The header files you have created.
# This is necessary to determine when to recompile for files.
# This should be a space (SPACE!) separated list of .h files
HFILES = ./lib/myLib.h ./lib/text.h ./lib/sprites.h
HFILES += ./images/title.h ./images/bg.h ./images/gameover.h
...
clean :
	...
	@rm -f *.o *.elf *.gba *.d ./lib/*.o ./lib/*.d ./images/*.o ./images/*.d
